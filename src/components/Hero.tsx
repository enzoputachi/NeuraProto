        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            <p 
              ...
              className="section-subtitle mt-3 sm:mt-6 mb-4 sm:mb-8 leading-relaxed opacity-0 animate-fade-in text-gray-400 font-normal text-base sm:text-lg text-left"
            >
          ...
          <div className="w-full lg:w-1 relative mt-6 lg:mt-0">
            {lottieData ? (
