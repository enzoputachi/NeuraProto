    ...
    const handleScroll = () => {
      if (!ticking.current) {
        ...
        window.requestAnimationFrame(() => {
          ...
          if (progress >= 0.8) setActiveCardIndex(2);
          else if (progress >= 0.6) setActiveCardIndex(1.5); // Intermediate state
          else if (progress >= 0.4) setActiveCardIndex(1);
          else if (progress >= 0.2) setActiveCardIndex(0.5); // Intermediate state
